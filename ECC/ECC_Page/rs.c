...
main()
{
  ...
  if (CAPACITY > kk) {
    printf("Error: CAPACITY (= %d) can't be higher than the maximum amount of data to be encoded, which is defined by the value kk (= %d).\n", CAPACITY, kk);
    printf("Please adjust the value, and try again.");
    return 0;
  }
